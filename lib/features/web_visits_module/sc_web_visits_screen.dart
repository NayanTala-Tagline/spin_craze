...
import 'package:spin_craze/features/web_visits_module/provider/sc_visit_website_provider.dart';
...
class _ScWebVisitItem {
  const _ScWebVisitItem(this.title, this.url);
  final String title;
  final String url;
}
...
final _webVisitItems = <_ScWebVisitItem>[
  _ScWebVisitItem(
...
class ScWebVisitsScreen extends StatelessWidget {
  const ScWebVisitsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => ScVisitWebsiteProvider(),
      child: const _ScWebVisitsContent(),
    );
  }
}

class _ScWebVisitsContent extends StatefulWidget {
  const _ScWebVisitsContent();

  @override
  State<_ScWebVisitsContent> createState() => _ScWebVisitsContentState();
}

class _ScWebVisitsContentState extends State<_ScWebVisitsContent>
  ...
  Future<void> _launchVisitExternal(_ScWebVisitItem item) async {
  ...
  void _launchVisitInApp(_ScWebVisitItem item) {
    AnalyticsManager.instance.logEvent(
  ...
  void _showMissionBrief(int index, _ScWebVisitItem item) {
    AnalyticsManager.instance.logEvent(
        ...
        child: _ScCongratsDialog(
          ...
          onClaim: () async {
            ...
            if (claimedIndex != null) {
              await context.read<ScVisitWebsiteProvider>().claimReward(
                claimedIndex,
              );
              AnalyticsManager.instance.logEvent(
    ...
    return PopScope(
      ...
      child: CommonBackground(
        ...
        child: Scaffold(
          ...
          appBar: CommonAppBar(title: context.l10n.earnModuleWebTitle, showBack: true),
          body: SafeArea(
            top: false,
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final prov = context.watch<ScVisitWebsiteProvider>();
...
class _ScVisitTile extends StatelessWidget {
  const _ScVisitTile({
    required this.item,
    required this.onTap,
    this.isLocked = false,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        context.l10n.gameZoneCoinsReward(_coinsPerVisit),
            ...
            child: SlideTransition(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: AppSize.h16),
                  AdDisclaimerText(
                    show: RewardAdService.isWebsiteRewardAdEnabled,
                  ),
