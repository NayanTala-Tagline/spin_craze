...
class CelebrationOverlayContent extends StatefulWidget {
  const CelebrationOverlayContent({
    super.key,
    required this.icon,
    required this.title,
  ...
  @override
  State<CelebrationOverlayContent> createState() =>
      CelebrationOverlayContentState();
}

class CelebrationOverlayContentState extends State<CelebrationOverlayContent>
