...
class ScOnboardingRingDecor extends StatefulWidget {
  const ScOnboardingRingDecor({super.key});

  @override
  State<ScOnboardingRingDecor> createState() => _ScOnboardingRingDecorState();
}

class _ScOnboardingRingDecorState extends State<ScOnboardingRingDecor>
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        return CustomPaint(
          painter: _ScRingPainter(phase: _ctrl.value),
          size: Size.infinite,
        );
      },
    );
...
class _ScRingPainter extends CustomPainter {
  _ScRingPainter({required this.phase});
  ...
  static const _rings = <_ScRingLayer>[
    _ScRingLayer(radiusFactor: 1.30, baseAlpha: 0.18, phaseShift: 0.00),
    _ScRingLayer(radiusFactor: 1.02, baseAlpha: 0.28, phaseShift: 0.20),
    _ScRingLayer(radiusFactor: 0.78, baseAlpha: 0.40, phaseShift: 0.40),
    _ScRingLayer(radiusFactor: 0.55, baseAlpha: 0.55, phaseShift: 0.60),
  ];
  ...
  @override
  bool shouldRepaint(covariant _ScRingPainter oldDelegate) =>
