...
/// animations, the Next button (with inline loader) and the bottom [AdSlot].
...
class SelectionScaffold extends StatefulWidget {
  ...
  @override
  State<SelectionScaffold> createState() => _SelectionScaffoldState();
}

class _SelectionScaffoldState extends State<SelectionScaffold>
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SelectionScaffold._statusBarStyle,
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              color: SelectionScaffold._titleColor,
                              letterSpacing: 0.1,
                            ),
                          ),
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              ...
                              height: 1.5,
                              color: SelectionScaffold._bodyColor,
                            ),
                          ),
                        ],
                      ),
                  ...
                  child: FadeTransition(
                    ...
                    child: SlideTransition(
                      ...
                      child: GradientButton(
                        ...
                        height: AppSize.h54,
                        borderRadius: 30,
                        gradient: SelectionScaffold._nextGradient,
                        textStyle: TextStyle(
                          fontFamily: FontFamily.sFPro,
