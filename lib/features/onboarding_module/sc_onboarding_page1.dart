...
class ScOnboardingPage1 extends StatefulWidget {
  const ScOnboardingPage1({super.key, this.preloadedNativeAd});
  ...
  @override
  State<ScOnboardingPage1> createState() => _ScOnboardingPage1State();
}

class _ScOnboardingPage1State extends State<ScOnboardingPage1> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    AnalyticsManager.instance.logScreenView(
      ...
      screenClass: 'ScOnboardingPage1',
    );
    return ChangeNotifierProvider(
      create: (_) => ScOnboardingProvider(
        onboardingIndex: 1,
