...
class ScOnboardingPage2 extends StatelessWidget {
  const ScOnboardingPage2({super.key});

  @override
  Widget build(BuildContext context) {
    AnalyticsManager.instance.logScreenView(
      screenName: 'onboarding_2',
      screenClass: 'ScOnboardingPage2',
    );
    return ChangeNotifierProvider(
      create: (_) => ScOnboardingProvider(onboardingIndex: 2),
