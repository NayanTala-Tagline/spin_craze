...
class ScSelectionAds {
  ScSelectionAds({this.native, this.inter});
...
///
/// - The inline ad is shown at the bottom via `ScAdSlot`.
...
class ScSelectionAdProvider extends ChangeNotifier {
  ScSelectionAdProvider({
    ScSelectionAds? preloaded,
    AdData? nativeData,
    AdData? interData,
    this.nextNativeData,
    this.nextInterData,
