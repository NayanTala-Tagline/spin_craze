...
class RankPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      ...
      child: const _RankBody(),
    );
  }
}

class _RankBody extends StatefulWidget {
  const _RankBody();

  @override
  State<_RankBody> createState() => _RankBodyState();
}

class _RankBodyState extends State<_RankBody>
...
class _Podium extends StatelessWidget {
  const _Podium({required this.players, required this.animation});
            ...
            Opacity(
              ...
              child: Transform.translate(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    _Avatar(initial: _initial, size: AppSize.sp40),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _Avatar(initial: _initial, size: AppSize.sp36),
          SizedBox(width: AppSize.w12),
          Expanded(
            child: Column(
