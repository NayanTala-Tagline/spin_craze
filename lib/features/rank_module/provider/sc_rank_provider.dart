...
import '../model/sc_leaderboard_user_model.dart';

/// Duration of one leaderboard cycle.
const _kCycleDuration = Duration(minutes: 20);

class ScRankProvider extends ChangeNotifier {
  ...
  List<ScLeaderboardUser> top3 = [];
  List<ScLeaderboardUser> listUsers = [];
  ...
  Future<void> _fetchLeaderboard() async {
    try {
      ...
      while (top3.length < 3) {
        top3.add(ScLeaderboardUser('—', '0', 1));
      }
