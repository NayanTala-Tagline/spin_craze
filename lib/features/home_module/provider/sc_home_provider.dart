...
import 'package:spin_craze/features/home_module/widgets/sc_daily_checkin_dialog.dart';
...
class ScHomeProvider extends ChangeNotifier {
  ...
  void _showCheckinDialogIfNeeded() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      showDialog(
        context: ctx,
        builder: (_) => ScDailyCheckinDialog(
