...
class ScDailyCheckinDialog extends StatefulWidget {
  final int currentDay;
  final int rewardCoins;
  final VoidCallback onClaim;

  const ScDailyCheckinDialog({
    super.key,
  ...
  @override
  State<ScDailyCheckinDialog> createState() => _ScDailyCheckinDialogState();
}

class _ScDailyCheckinDialogState extends State<ScDailyCheckinDialog>
