...
/// package is used.
class ScSplashScreen extends StatefulWidget {
  const ScSplashScreen({super.key});

  @override
  State<ScSplashScreen> createState() => _ScSplashScreenState();
}

class _ScSplashScreenState extends State<ScSplashScreen>
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          if (_showNoInternet)
            _ScNoInternetView(onRetry: _onRetry, retrying: _retrying)
          else
...
class _ScNoInternetView extends StatelessWidget {
  const _ScNoInternetView({required this.onRetry, required this.retrying});
