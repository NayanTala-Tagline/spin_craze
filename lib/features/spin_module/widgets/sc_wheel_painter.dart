...
class ScWheelPainter extends CustomPainter {
  ScWheelPainter(this.segments);
  final List<ScWheelSegment> segments;
...
class ScSpinWheelWidget extends StatelessWidget {
  const ScSpinWheelWidget({
  ...
  Widget build(BuildContext context) {
    return Transform.rotate(
      ...
      child: SizedBox(
        width: size,
        height: size,
        child: CustomPaint(painter: ScWheelPainter(segments)),
      ),
    );
  }
}
